...
| ROTA-T065-CONFIGURABLE-ROLES | Codex | CC | `task/ROTA-T065-CONFIGURABLE-ROLES` | audit `86051fd` na fix `47ee3a1` (brief `b038bb360de9837a2e9931d6e736774e2fc1e3a8`) | CODEX_REPORTED | **FAIL R5 — R4 zamknięte 4/4, ale normalny onboarding nadal tworzy aktywny membership ORDINARY bez stanowiska.** Raport: `tasks/ROTA-T065-CONFIGURABLE-ROLES/round_01/tests/tests_r5.txt`; reproduktor `audit_r5_repro.py` (1 failed). POST „Dodaj osobę” zwraca 204 i zapisuje `enabled=True, position_role_id=None`, choć sekcje 4/9 wymagają dokładnie jednego aktywnego stanowiska. To podstawowy flow jednego Site, nie stare/syntetyczne dane ani atak. Wąska korekta: wybór aktywnej roli podczas dołączania ORDINARY i atomowy zapis membershipu; OCHRONA bez zmian. Zachowane reproduktory R4: 4 passed; wąska macierz sąsiednia: 57 passed. Bez pełnej regresji, symulatorów i benchmarków. Uwaga o 8 plikach poza TASK_SCOPE pozostaje osobna i nie jest źródłem R5-01. |
