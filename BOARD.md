...
| ROTA-OCHRONA-EDIT-7D-LIMIT | Architekt | CC | `task/ROTA-OCHRONA-EDIT-7D-LIMIT` | brief `4faf053025b4fffc4485fbbceeaaac7d14a82a91` | OWNER_DECISION_NEEDED | **OWNER zaakceptował zakres okienka.** Przeczytaj `tasks/ROTA-OCHRONA-EDIT-7D-LIMIT/brief.md` na wskazanym exact SHA. Cel: edycja istniejącego progu ruchomych 7 dni wyłącznie dla OCHRONA, komunikat + wymagane potwierdzenie przy >72 h, zapis przez dotychczasowy owner profilu i pamięć decyzji, bez ruszania reguł ORDINARY, solvera i odpoczynków. Codex niedostępny: wykonaj krótki precheck briefu i przekaż wyłącznie realne blokery/zbędny zakres; OWNER decyduje o wyjątkowej zgodzie na implementację bez Codexa. Bez merge bez decyzji OWNERA. |