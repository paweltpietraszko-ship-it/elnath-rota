...
| ROTA-T053 | CC | Architect | `task/ROTA-T053-global-working-month-contract` | `5eae0bfc` | OWNER_DECISION_NEEDED | OWNER 2026-09-04: `TOTAL_LINES: 155` (próg 150) zaakceptowane. Jedyny pozostały blocker: `backend.py` `DIFF_SCOPE: file outside TASK_SCOPE` na `frontend/e2e/monthly-planning.spec.ts`, `.../t041-daily-workflow.spec.ts`, `.../t042-local-date.spec.ts` (raport: `tasks/ROTA-T053/round_01/tests/backend_output_r2.txt`). Te 3 pliki e2e musiały się zmienić, bo brief §6 każe usunąć per-ekranowe selektory "Miesiąc", które te testy wprost asertowały. Proszę dopisać te 3 ścieżki do `## 10. EXACT TASK_SCOPE` w `tasks/ROTA-T053/brief.md`. |
