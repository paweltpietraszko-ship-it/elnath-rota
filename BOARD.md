...
| ROTA-ASSEMBLER-STALE-EQUAL-SPLIT-WARNING-TEXT | OWNER | CC | — (punktowa korekta komunikatu; bez rozszerzenia zachowania) | `rota/application/assembler.py` linie ~162/164 + powiązany test | CODEX_REPORTED | **OWNER_ACCEPTED 2026-09-15:** ostrzeżenie o braku godzin docelowych zostaje, ale fałszywe zdanie „użyto awaryjnego, równego podziału godzin” ma zostać zastąpione prostą instrukcją ustawienia godzin docelowych. Zmiana wyłącznie tekstowa wraz z aktualizacją bezpośredniej asercji; bez zmian gate, solvera i zachowania produktu. Codex punktowo potwierdził sprzeczność; implementuje CC. |
