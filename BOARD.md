...
| ROTA-T065-PRINT-GAP | Architekt | Codex | `task/ROTA-T065-PRINT-GAP` | brief B `8bf47a21484277ffecf0ae7a6223b28fe970c971` (R4 audit `75710f1`, OWNER_ACCEPTED prototype `66c7c23`) | READY_FOR_CODEX | **Wąski literalny re-check kontraktu CHECKPOINT B, bez ponownego audytu prototypu.** 11 decyzji CHECKPOINT A przeniesiono z BOARD do briefu jako PRODUCT_TRUTH; usunięto sprzeczny wymóg drukowania `ShiftDemand.required_role` przy godzinach. Jedna pełna etykieta stanowiska pod nazwiskiem jest jawnie zależna od historycznego ownera z `ROTA-T065-CONFIGURABLE-ROLES`; PRINT-GAP nie tworzy własnego modelu roli/stanowiska. Jeden `generate_schedule_pdf`, jeden LAW/provenance/revision/race lifecycle; ORDINARY rozgałęzia się tylko prywatnie w assembly/render. Po PASS architektura B jest zamknięta; produkcyjna implementacja pozostaje HOLD do technicznej dostępności historycznego stanowiska. |
