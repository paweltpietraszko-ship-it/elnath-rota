...
validator found in the same candidate (e.g. EMP-02), silently dropping it
from the payload.
"""
...
def test_r15_2_uncapped_load_fallback_does_not_mask_emp02(monkeypatch):
    solved = Assignment(
    ...
    # EMP-02 on top of the real LOAD-01 trigger (threshold=11h < 12h shift).
