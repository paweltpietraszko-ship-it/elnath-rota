...
def _seed_minimal(conn, *, site_id: str = SITE, coordinator_id: str = COORDINATOR) -> None:
    ...
    save_site(conn, Site(site_id, "PROF-1", "Site One", True, planning_regime=SitePlanningRegime.OCHRONA))
...
def _setup_two_sites(tmp_path, *, membership_kind_b: MembershipKind = MembershipKind.LOCAL):
    ...
    save_site(conn, Site("SITE-B", "PROF-1", "Site B", True, planning_regime=SitePlanningRegime.OCHRONA))
