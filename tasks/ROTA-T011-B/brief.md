...
STATUS: DRAFT FOR CODEX AUDIT — ROUND 2 PASS, ROUND 3 FAIL (B-R3-1, patched
below by CC per Codex round 3 closure condition -- tasks/ROTA-T011-B/
round_01/tests/tests_r3.txt)
DATE: 2026-08-14
...
DEPENDS_ON: ROTA-T011-A (FINDING B-R3-1, round 3: tests/test_t011_b_
