...
# inequality, add_max_equality ReLU, tightened domain, boolean gate) broke
# CP-SAT's ability to prove optimality on real objects (0.4s -> 45s+,
# often never converging at all) -- see
# arch/FINDING_2026-09-08_T058_EQUITY_DEADBAND_CPSAT_PERFORMANCE.md. Even
# the alternative of reordering rhythm-over-equity priority via a plain
