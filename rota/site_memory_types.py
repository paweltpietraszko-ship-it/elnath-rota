...
class CoordinatorActionKind(str, Enum):
    ...
    SCHEDULE_VERSION_DELETED = "SCHEDULE_VERSION_DELETED"
    SITE_ROLE_CATALOG_CHANGED = "SITE_ROLE_CATALOG_CHANGED"
    ROLE_COVERAGE_AUTHORIZATION_CHANGED = "ROLE_COVERAGE_AUTHORIZATION_CHANGED"
